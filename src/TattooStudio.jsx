...
export default function TattooStudio({ onBackToHub, initialLang = 'ru' }) {
  ...
  const t = {
    ru: {
      ...
      presetFineLine: "🖋️ Тонкие Линии (Fine Line)",
      presetIrezumi: "🐉 Японский Ирэдзуми",
      presetCyber: "⚡ Кибер-Трайбл",
      presetWatercolor: "🎨 Акварельный Сплеск",
      badgeStencil: "🖋️ ГОТОВО К ТРАНСФЕРУ",
      badgeFineLine: "⚡ ТОНКАЯ ГРАФИКА",
      badgeViral: "🔥 ВИРУСНЫЙ ЭСКИЗ",
      badgeFlash: "👑 АВТОРСКИЙ ФЛЭШ",
      badgeNone: "🚫 Без бейджа",
      placeForearm: "📍 ПРЕДПЛЕЧЬЕ",
      placeChest: "📍 ГРУДЬ",
      placeBack: "📍 СПИНА",
      placeShoulder: "📍 ПЛЕЧО",
    ...
    ua: {
      ...
      presetFineLine: "🖋️ Тонкі Лінії (Fine Line)",
      presetIrezumi: "🐉 Японський Іредзумі",
      presetCyber: "⚡ Кібер-Трайбл",
      presetWatercolor: "🎨 Акварельний Сплеск",
      badgeStencil: "🖋️ ГОТОВО ДО ТРАНСФЕРУ",
      badgeFineLine: "⚡ ТОНКА ҐРАФІКА",
      badgeViral: "🔥 ВІРУСНИЙ ЕСКІЗ",
      badgeFlash: "👑 АВТОРСЬКИЙ ФЛЕШ",
      badgeNone: "🚫 Без бейджа",
      placeForearm: "📍 ПЕРЕДПЛІЧЧЯ",
      placeChest: "📍 ГРУДИ",
      placeBack: "📍 СПИНА",
      placeShoulder: "📍 ПЛЕЧЕ",
    ...
    en: {
      ...
      studioSub: "Tattoo Stencil & Flash Design Engine",
      backHub: "To Hub",
      ...
      customPromptLabel: "3. Pattern Details",
