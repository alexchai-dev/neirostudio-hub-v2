...
export default function FoodStylingStudio({ onBackToHub, initialLang = 'ru' }) {
  ...
  const t = {
    ru: {
      ...
      presetMichelin: "⭐ Ресторанный Michelin",
      presetRustic: "🪵 Деревянная Подача",
      presetDark: "🔥 Темный Гастро-Стиль",
      presetClean: "☀️ Светлое Меню",
      badgeChef: "🍳 ШЕФ-РЕКОМЕНДУЕТ",
      badgeBestseller: "🔥 БЕСТСЕЛЛЕР",
      badgeVegan: "🌱 100% ОРГАНИК",
      badgeSpicy: "🌶️ ОСТРОЕ БЛЮДО",
      ...
      previewHeader: "Превью Блюда",
      canvasPill: "Фуд-Фотография",
    ...
    ua: {
      ...
      presetMichelin: "⭐ Ресторанний Michelin",
      presetRustic: "🪵 Дерев'яна Подача",
      presetDark: "🔥 Темний Ґастро-Стиль",
      presetClean: "☀️ Світле Меню",
      badgeChef: "🍳 ШЕФ-РЕКОМЕНДУЄ",
      badgeBestseller: "🔥 БЕСТСЕЛЕР",
      badgeVegan: "🌱 100% ОРГАНІК",
      badgeSpicy: "🌶️ ГОСТРА СТРАВА",
      badgeNone: "🚫 Без бейджа",
      posTopLeft: "↖️ Зверху ліворуч",
      posTopRight: "↗️ Зверху праворуч",
      posBottomLeft: "↙️ Знизу ліворуч",
      posBottomRight: "↘️ Знизу праворуч",
      previewHeader: "Прев'ю Страви",
      canvasPill: "Фуд-Фотографія",
    ...
    en: {
      ...
      customPromptLabel: "3. Ingredient Details",
      customPromptPlaceholder: "e.g. double bacon, microgreens, steam...",
      badgeLabel: "4. Gastro Status Badge",
      positionLabel: "5. Badge Position",
      specLabel: "6. Weight, Calories & Price",
      specPlaceholder: "e.g. 380g • 520 kcal | $14.99",
      generateBtn: "Generate Food Photography",
      ...
      previewHeader: "Dish Preview",
      canvasPill: "Food Photography",
      downloadBtn: "Download Food Photo",
  ...
  const handleDownload = () => {
    ...
    try {
      ...
      link.download = `food-styling-hd-${Date.now()}.png`;
      link.href = dataUrl;
