...
export default function NemotronCopywriterStudio({ onBackToHub, initialLang = 'ru' }) {
  ...
  const t = {
    ru: {
      ...
      badgeNemotron: "🚀 NVIDIA NEMOTRON-70B",
    ...
    en: {
      ...
      badgeLabel: "4. SMM Status Badge (Layer 2)",
      positionLabel: "5. Badge Safe Position",
      generateBtn: "Generate Nemotron-70B Copy",
      presetCyberpunk: "🚀 Cyberpunk Neon",
      presetMinimal: "🖤 Clean Minimal Dark",
      presetLuxury: "👑 Luxury Gold Gradient",
      presetEmerald: "🟢 Emerald Business",
      ...
      previewHeader: "Post & Card Preview (Live 1000x1000 Canvas)",
      copyBtn: "📋 Copy Post Text to Clipboard",
      downloadBtn: "Download 8K Card",
      unlockBtn: "🎁 Remove Watermark & Get 8K",
      modalUnlockTitle: "Growth Hack: Unlock 8K & Copy Text",
