...
export default function AmazonKDPStudio({ onBackToHub, initialLang = 'ru' }) {
  ...
  const t = {
    ...
    en: {
      ...
      customPromptLabel: "3. Character Details (Optional)",
      customPromptPlaceholder: "e.g. cat with glasses, cherry blossom, coffee mug...",
      badgeLabel: "4. Print Status Badge (Layer 2)",
      positionLabel: "5. Badge Safe Position",
      generateBtn: "Generate 8K Print / Sticker",
      presetSticker: "✂️ Cutout Sticker Pack",
      presetKdp: "📚 KDP Coloring Page",
      presetKawaii: "🐱 Kawaii Cute Vinyl",
      presetVintage: "🌸 Vintage Botanical",
      ...
      previewHeader: "Print Preview (Live 1000x1000 Canvas)",
      downloadBtn: "Download 8K Print Art",
      unlockBtn: "🎁 Remove Watermark & Get 8K",
      modalUnlockTitle: "Growth Hack: Unlock 8K HD",
      modalUnlockDesc: "Claim +3 free ⚡ generations & download watermark-free 8K print art in 1 click!",
